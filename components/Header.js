            ...
            <div className="inline-flex md:hidden">
                {
                    ...
                    <div className="fixed top-0 right-0 bottom-0 z-10 bg-white w-72 h-screen"> {/* X */}
                        ...
                        <p className="mx-5 py-2 border-b-2 border-gray-200">Link1</p>
                        <p className="mx-5 py-2 border-b-2 border-gray-200">Link2</p>
                        <p className="mx-5 py-2 border-b-2 border-gray-200">Link3</p>
                        <p className="mx-5 py-2 border-b-2 border-gray-200">Link4</p>
                        </div>
                    </div>  
                    :
                    <div> {/* Hamburger Menu */}
